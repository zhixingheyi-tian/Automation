...
if __name__ == '__main__':
    ...
    cmpFile.write(htmlContent.format(
        "http://" + os.environ.get("PACKAGE_SERVER", "10.239.47.111") + "/oap_release_function_result/" +
        os.path.basename(args[-3]).split("-")[0][-10:] + "/" + os.path.basename(os.path.dirname(args[-3])) + "_" + socket.gethostname(),
        os.path.basename(os.path.dirname(args[-3])),
        "http://" + os.environ.get("PACKAGE_SERVER", "10.239.47.111") + "/oap_release_function_result/" +
        os.path.basename(args[-2]).split("-")[0][-10:] + "/" + os.path.basename(os.path.dirname(args[-2])) + "_" + socket.gethostname(),
        os.path.basename(os.path.dirname(args[-2])), htmlTables))
