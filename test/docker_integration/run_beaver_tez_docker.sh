...
expect {
        "~]#" {send "rm -rf /etc/yum.repos.d/CentOS-*;cd /home/$project_name/;benchmark/BBonHoTez.py deploy_and_run /opt/tezconf/ -pat\r"}
}
expect {
