...
expect {
        "~]#" {send "chmod +x /home/$project_name/bin/*;rm -rf /etc/yum.repos.d/CentOS-*;cd /home/$project_name/;benchmark/TPCDSonHoS.py deploy_and_run /opt/sparkconf/\r"}
}
expect {
