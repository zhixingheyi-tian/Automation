...
-- baseline options
-- ###########################
--set hive.execution.engine=spark; // set above
...
-- set spark.master=yarn-client;   // set in spark-defaults.conf
-- set spark.eventLog.enabled=true;   // set in spark-defaults.conf
-- set spark.eventLog.dir=hdfs://master_hostname:9000/spark-history-server  // set in spark-defaults.conf
-- set spark.serializer=org.apache.spark.serializer.KryoSerializer; // set in spark-defaults.conf
...
-- set spark.network.timeout=3600s;  // set in spark-defaults.conf
...
-- set spark.executor.cores=7;  // set in spark-defaults.conf
-- set spark.executor.memory=26g;  // set in spark-defaults.conf
-- set spark.yarn.executor.memoryOverhead=4096;  // set in spark-defaults.conf

-- set spark.dynamicAllocation.enabled=true;  // set in spark-defaults.conf
-- set spark.shuffle.service.enabled=true;  // set in spark-defaults.conf

-- set spark.executor.extraClassPath=/opt/Beaver/hive/conf;  // set in spark-defaults.conf
-- set spark.driver.extraClassPath=/opt/Beaver/hive/conf;  // set in spark-defaults.conf
-- set spark.yarn.jar=local:///opt/spark163_noPhive/lib/spark-assembly-1.6.3-hadoop2.6.0.jar
...
set hive.mapjoin.smalltable.filesize=2147483648;
set hive.auto.convert.join.noconditionaltask.size=3221225472;
set hive.strict.checks.cartesian.product=false;
set hive.spark.job.monitor.timeout=36000s;
