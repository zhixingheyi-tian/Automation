...
bin/runBBonHoS.py $function $Beaver_home/milestone/hive_parquet_vectorization
...
bin/runBBonHoS.py undeploy $Beaver_home/milestone/hive_parquet_vectorization