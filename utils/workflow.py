...
def create_tree_by_appendList(treeRoot ,list):
    if treeRoot.contains_subFile(list[0]):
        ...
        if len(list) == 2:
            ...
            treeRoot.add_subFile(subfile)
            list.remove(subfile.fileName)
            create_tree_by_addList(subfile, list)
    else:
        tmp_root = treeRoot
        for dir in list:
...
if __name__ == '__main__':
    ...
    # update_workflow("/home/oap_product/Beaver_modify/repo/workflows/oap_release_cluster_3_stability_test_2")
    # update_workflow("/home/oap_product/Beaver_modify/repo/workflows/oap_release_cluster_1_function")
